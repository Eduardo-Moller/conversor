...
function converter(){
    ...
    if(temp=="c"){
        ...
        p.innerHTML ="Em  Farenheit = "+f+"<br>Em  Kelvin = "+k+"<br>Em  Ramkine = "+r;
    }
    else if(temp=="f"){
        ...
        p.innerHTML ="Em  Celsius = "+c+"<br>Em  Kelvin = "+k+"<br>Em  Ramkine = "+r;
    }
    else if(temp=="k"){
        ...
        p.innerHTML ="Em  Celsius = "+c+"<br>Em  Farenheit = "+f+"<br>Em  Ramkine = "+r;
    }
    else if(temp=="r"){
